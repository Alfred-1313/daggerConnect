...
GITHUB_REPO="https://github.com/Alfred-1313/daggerConnect"
LATEST_RELEASE_API="https://api.github.com/repos/Alfred-1313/daggerConnect/releases/latest"
...
download_binary() {
    ...
    if [ -z "$LATEST_VERSION" ]; then
        echo -e "${YELLOW}⚠️  Could not fetch latest version, using v1.0.0${NC}"
        LATEST_VERSION="v1.0.0"
    fi

    BINARY_URL="https://github.com/Alfred-1313/daggerConnect/releases/download/${LATEST_VERSION}/DaggerConnect"
